...
```bash
git clone https://github.com/mokshjain/binary-analysis-tool.git
...
├── backend/
│   └── crates/
│       ├── aegis-bat-engine/          # Core analysis library
│       │   └── src/
